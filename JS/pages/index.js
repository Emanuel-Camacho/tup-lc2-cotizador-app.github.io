...
const LISTA_NUBE = {}; // diccionario para guardar MONEDAS las monedas y subirlas al localStorage
    ...
    fetch("https://dolarapi.com/v1/dolares")
        ...
        .then(data => {
            ...
            data.forEach((valor, indice) => {
                ...
                LISTA_NUBE[`moneda${indice}`].fechaActualizacion = fechaExacta;
            });
    ...
    fetch("https://dolarapi.com/v1/cotizaciones")
        ...
        .then(data => {
            ...
            data.forEach((valor, indice) => {
                ...
                LISTA_NUBE[`otro${indice}`].fechaActualizacion = fechaExacta;
            });
...
// arreglo para guardar / sacar monedas de favoritos
let FAVORITOS = {};

// para que al recargar la pagina y quede prendida la estrella
    ...
    switch (buttonId) {
        ...
        case 'boton7':
            ...
            if (boton_fav.dataset.state == 'off') {
                boton_fav.style.color = 'gold';
                showAlert('success', 'Agregado a favoritos con exito');
                FAVORITOS.otro1 = LISTA.otro1;
                boton_fav.dataset.state = 'on';
            } else {
                boton_fav.style.color = 'black';
                showAlert('success', 'Eliminado de favoritos con exito');
                delete FAVORITOS.otro1;
                boton_fav.dataset.state = 'off';
            }
            break;
        ...
        case 'boton8':
            ...
            if (boton_fav.dataset.state == 'off') {
                boton_fav.style.color = 'gold';
                showAlert('success', 'Agregado a favoritos con exito');
                FAVORITOS.otro2 = LISTA.otro2;
                boton_fav.dataset.state = 'on';
            } else {
                boton_fav.style.color = 'black';
                showAlert('success', 'Eliminado de favoritos con exito');
                delete FAVORITOS.otro2;
                boton_fav.dataset.state = 'off';
            }
            break;
        ...
        case 'boton9':
            ...
            if (boton_fav.dataset.state == 'off') {
                boton_fav.style.color = 'gold';
                showAlert('success', 'Agregado a favoritos con exito');
                FAVORITOS.otro3 = LISTA.otro3;
                boton_fav.dataset.state = 'on';
            } else {
                boton_fav.style.color = 'black';
                showAlert('success', 'Eliminado de favoritos con exito');
                delete FAVORITOS.otro3;
                boton_fav.dataset.state = 'off';
            }
            break;
        ...
        case 'boton10':
            ...
            if (boton_fav.dataset.state == 'off') {
                boton_fav.style.color = 'gold';
                showAlert('success', 'Agregado a favoritos con exito');
                FAVORITOS.otro4 = LISTA.otro4;
                boton_fav.dataset.state = 'on';
            } else {
                boton_fav.style.color = 'black';
                showAlert('success', 'Eliminado de favoritos con exito');
                delete FAVORITOS.otro4;
                boton_fav.dataset.state = 'off';
            }
            break;
    }
        ...
        switch (seleccion) {
            ...
            case 'FAVORITOS':
                ...
                if (agregados_favoritos) {
                    ...
                    if (agregados_favoritos.otro1) {
                        euro.style.display = 'flex';
                        bool_favor = true;
                    }
                    if (agregados_favoritos.otro2) {
                        realBR.style.display = 'flex';
                        bool_favor = true;
                    }
                    if (agregados_favoritos.otro3) {
                        pesoCH.style.display = 'flex';
                        bool_favor = true;
                    }
                    if (agregados_favoritos.otro4) {
                        pesoUYU.style.display = 'flex';
                        bool_favor = true;
                    }
